...
<?php
    ...
    if(isset($_GET['notification_id'])) {
        ...
        if ($action_g === "A")
        {
            ...
            {
                if ($stage === "teacher") {
                    mysqli_query( $connect, "UPDATE teacher_notification set stage = 'admin' where notification_id = $notification_id_g" );
                }else{
...
<body>
    ...
    <div class="notifications">
        ...
        $results = mysqli_query( $connect, 
            "SELECT * 
            FROM teacher_notification WHERE stage NOT LIKE '%admin%'") 
